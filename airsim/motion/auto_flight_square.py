...
client.moveToZAsync(-3, 1).join() # move to z = -3m, 1m/s
client.moveToPositionAsync(50, 0, -30, 2).join() # move to (50, 0, -30), 2m/s
client.moveToPositionAsync(50, 50, -30, 2).join()
client.moveToPositionAsync(-50, 50, -30, 2).join()
client.moveToPositionAsync(-50, -50, -30, 2).join()
client.moveToPositionAsync(50, -50, -30, 2).join()
